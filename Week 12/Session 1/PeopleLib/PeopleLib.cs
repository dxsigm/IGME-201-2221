...
namespace PeopleLib
{
    ...
    public class Student : Person, IPerson, IStudent, ICourseList
    {
        ...
        public Student()
        {
            // because CourseList is a reference variable which starts as null, we need to create the List object
    ...
    public class Teacher : Person, IPerson, ICourseList
    {
        ...
        public Teacher()
        {
            // because CourseList is a reference variable, we need to create the List object
            CourseList = new List<string>();
        }
