...
namespace BTree
{
    ...
    public class BTree
    {
        ...
        // These four traveral methods use a Depth First Search (DFS)
        //////////////////////////////////////////////////////////
        ...
        public static void BreadthFirstTraversal(BTree root)
        {
            if( root == null )
            {
                return;
            ...
            while( queue.Count > 0 )
            {
                BTree curNode = queue.Dequeue();
                if( curNode.isData )
                {
                    PrintThisNode(curNode);
                }

                if( curNode.ltChild != null)
                {
                    queue.Enqueue(curNode.ltChild);
                }

                if (curNode.gteChild != null)
                {
                    queue.Enqueue(curNode.gteChild);
                }
            }
        }
